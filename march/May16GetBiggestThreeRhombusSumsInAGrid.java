...
public class May16GetBiggestThreeRhombusSumsInAGrid {
    class Solution {
    ...
    public static void main(String[] args) {
        ...
        Solution solution = new May16GetBiggestThreeRhombusSumsInAGrid().new Solution();
        int[] result = solution.getBiggestThree(grid);
        for (int num : result) {
            System.out.print(num + " ");
        }
        
        solution = new May16GetBiggestThreeRhombusSumsInAGrid().new Solution();
